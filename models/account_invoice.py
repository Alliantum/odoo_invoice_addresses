...
class AccountMove(models.Model):
    ...
    partner_invoice_id = fields.Many2one('res.partner', string="Invoice Address", change_default=True, tracking=True,
        ondelete='restrict', help="You can find a contact by its Name, TIN, Email or Internal Reference.", domain="[('id', 'child_of', partner_id)]")
    #partner_shipping_id is an existing field but we are going to let the user choose only the children of the partner selected
